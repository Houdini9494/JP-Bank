...
<template>
  <form @submit.prevent="handleSubmit" class="login-form">
    <div class="form-group">
      ...
      <input type="email" id="email" placeholder="email@mail.com" v-model="email" required :disbled="isLoading"/>
    </div>

    <div class="form-group">
      <label for="password">Password</label>
      <div class="psw-wrapper">
        <input :type="showPassword ? 'text' : 'password'" id="password" placeholder="password" v-model="password" required :disbled="isLoading"/>
    ...
    <button type="submit" class="btn-primary" :disbled="isLoading">Accedi</button>
  </form>
</template>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    console.error("Errore durante il login.", err.response.data.message)
  } finally{
