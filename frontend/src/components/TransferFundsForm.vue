...
onMounted(async () => {
    try {
        ...
        error.value = 'Errore nel caricamento dei conti'
    }
})
...
const submitTransfer = async() => {
  try {
    ...
    console.error('Errore nella transazione:', err.response?.data || err.message);
    error.value = err.response?.data?.message || 'Errore nella transazione';
  }
}
</script>
