...
const actions = {
  ...
  async login({ commit }, credentials) {
    try {
      ...
      commit('SET_ERROR', 'Credenziali non valide')
    }
  },
  //esegue la registrazione, rimuove gli errori e reindirizza al loginoppure in caso di errore mostra un errore generico
  async register({ commit }, user) {
    try {
      ...
      commit('SET_ERROR', 'Errore durante la registrazione')
      throw error
    }
  },
